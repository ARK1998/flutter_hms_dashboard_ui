...
class DepartmentListItemWrapper extends StatefulWidget {
  const DepartmentListItemWrapper({
    Key? key,
    required this.child,
  ...
  @override
  State<DepartmentListItemWrapper> createState() =>
      _DepartmentListItemWrapperState();
}

class _DepartmentListItemWrapperState extends State<DepartmentListItemWrapper>
